CREATE DATABASE  IF NOT EXISTS `practicas` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `practicas`;
...
INSERT INTO `pr_cliente` VALUES (10221,'Abelardo','Gutierrez','Samora','10221ags'),(10222,'Felix','Santiago','Rivera','10222fsr'),(10223,'Miguel','Torres','Perez','10223mtp'),(10224,'Tifany','Rivera','Perez','10224trp'),(10225,'Candy','Salazar','Mendoza','10225csm'),(10226,'Carmen','Itzel','Lugo','10226cil'),(10228,'Cheveno','Andres','Rivera','10228car'),(10229,'Rosa','Itzel','Mendoza','10229rim'),(10230,'Dulce','Maria','Rosario','10230dmr');
...
INSERT INTO `pr_cotitular` VALUES (100,'Erasto','Flores','Torres','100EFT','Hermano',10225),(101,'Yuridia','Luis','Flores','101ylf','Hermano',10221),(102,'Carina','Castro','Sosa','102ccs','Primo',10223),(103,'Fatima','Catalina','Hernández','103fch','Primo',10222),(104,'Estefany','Hernández','Guzman','104ehg','Padre',10224),(105,'Dulce','Flores','Dias','105dfd','Padre',10228),(106,'Miriam','Sosa','Torres','106mst','Hermano',10226),(107,'Aldana','Itzel','Lauman','107ail','Hermano',10229);
...
INSERT INTO `pr_cuenta` VALUES (132210,'Personal','2016-02-13',5000,10225,80801022),(132211,'Empresarial','2016-04-11',1200,10221,80801031),(132212,'Personal','2015-02-12',600,10223,80801042),(132213,'Empresarial','2016-01-06',13000,10222,80801022),(132214,'Empresarial','2017-01-23',50000,10229,80801042),(132215,'Personal','2016-12-27',17000,10224,80801315),(132216,'Personal','2016-03-18',18000,10228,80801022),(132217,'Personal','2016-02-09',28000,10226,80801322);
...
-- Dump completed on 2017-03-07  0:25:18
